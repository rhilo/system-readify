...
print('Step 1: Downloading Docker installation script')
try:
...
try:
    ...
    print(f'Exception while setting execute permissions: {e}')

# Step 3: Remove Snap packages
logging.info('Step 3: Removing Snap packages')
print('Step 3: Removing Snap packages')
...
print('Step 4: Disabling Snapd services')
...
print('Step 5: Disabling Snapd seeded service')
...
print('Step 6: Removing Snapd cache')
...
print('Step 8: Removing Snap user directory')
run_command('rm -rf /root/snap')


# Step 9: Execute the Docker installation script
logging.info('Step 9: Running Docker installation script')
print('Step 9: Running Docker installation script')
...
print('Step 10: Configuring firewall and usermod')
...
print('Step 11: Removing packages')
